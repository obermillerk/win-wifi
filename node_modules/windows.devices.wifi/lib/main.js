...
try {
  ...
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Devices_WiFi.d.js)'))) {
    module.exports = require('./NodeRT_Windows_Devices_WiFi.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.Networking.Connectivity', 'Windows.Foundation', 'Windows.Security.Credentials'];
