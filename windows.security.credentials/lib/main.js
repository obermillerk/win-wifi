...
try {
  ...
  if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Security_Credentials.d.js)'))) {
    module.exports = require('./NodeRT_Windows_Security_Credentials.d.js');
  }
...
var externalReferencedNamespaces = ['Windows.Storage.Streams', 'Windows.Security.Cryptography.Core', 'Windows.Foundation', 'Windows.System'];
